...
# This script is copyrighted by the University of Chicago. All rights reserved.
#
...
#
# Reference for the original Apache 2.0 licensed script:
# https://github.com/globus/globus-connect-server-deploy/blob/f19ba36b1dc68ce334f4484a79417dfc6bd128ea/docker/entrypoint.sh
